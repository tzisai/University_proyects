...
Objetivo: Realizar un ejemplo de destructor en un codigo que contenga clases,metodos,atributos y destructor.
...
private://atributos
    ...
    string nombre;
public:
    parangatirimicuaro(int, int, string);//constructor 
    ~parangatirimicuaro();//destructor
    void parangatiricuarizar();//metodos
    void volar();
    void stats();
};
...
int main(){//instanciamiento de objetos
