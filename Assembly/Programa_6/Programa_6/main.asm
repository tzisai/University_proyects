...
MAIN_LOOP:
	...
	IN NumeroA, PORTA	; Lee el estado de los pines en PORTA y lo guarda en NumeroA
	IN NumeroC, PORTC	; Lee el estado de los pines en PORTC y lo guarda en NumeroC
