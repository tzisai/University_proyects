...
#include <time.h>
#define MAX 40
//FUNCION DE IMPRESION DE LA BASE DE DATOS 
...
int main(){
	...
	char nombres [10][20]= {"Martin ", "Yocsan ", "Alan ","Eduardo ", "Juan ", "Pablo ", "Jesus ","Alexis ","Guadalupe ","Omar "};
	char apellidos_1 [10][20]={"Hernández ","García ","Martínez ", "López ","González ","Rodrígez ","Pérez ","Sánchez ","Ramírez ","Torres "};
	char apellidos_2 [20][20]={"Flores","Gómez","Díaz","Vázquez","Cruz","Morales","Reyes","Reyes","Ortiz","Jiménez","Aguilar"};
	...
	//COMPARACION ENTRE DOS NOMBRES QUE USANDO LA PROPIEDAD DE STRCMP QUE AL COMPARLAS 
	//DA COMO RESULTADO UN NUMERO NEGATIVO O POSITIVO SEGUN SI ESTA VA DESPUES O ANTES DE LA COMPARADA Y EN BASE A ESTO SE HACE UN BOOBLE SORT 
	// DE TODOS LOS ELEMTOS DE EL REGISTRO QUE COMPARTEN EL MISMO INDICE.
   ...
   // MENU PRINCIPAL Y LECTURA DE ELECCION
   do{
